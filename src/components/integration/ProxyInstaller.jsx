...
const INSTALL_STEPS = [
  {
    ...
    desc: "Si no tienes Python instalado en el PC de oficina:",
    action: { label: "Descargar Python 3.11", href: "https://www.python.org/ftp/python/3.11.9/python-3.11.9-amd64.exe" },
    note: "Marca '✓ Add Python to PATH' durante la instalación.",
  },
  {
    icon: Terminal,
    title: "2. Instala dependencias",
    desc: "Abre CMD o PowerShell y ejecuta:",
    code: "pip install fastapi uvicorn pyodbc python-dotenv",
  },
  {
    icon: Server,
    title: "3. Descarga los archivos",
    desc: "Crea una carpeta (ej: C:\\alma_proxy\\) y guarda dentro:",
    files: ["alma_proxy.py", ".env"],
  },
  {
    icon: Key,
    title: "4. Configura el .env",
    desc: "Edita el .env con los datos de tu SQL Server:",
    code: ENV_TEMPLATE,
  },
  {
    icon: Play,
    title: "5. Arranca el proxy",
    desc: "Haz doble clic en arrancar.bat o ejecuta en CMD:",
    code: "python alma_proxy.py",
    note: "El proxy quedará escuchando en http://PC_OFICINA:8099",
  },
  {
    icon: CheckCircle2,
    title: "6. Verifica que funciona",
    desc: "Abre en el navegador del mismo PC:",
    code: "http://localhost:8099/health",
    note: "Deberías ver: {\"status\": \"ok\", \"db\": \"Alma_AlonsoMercader\"}",
  },
];
